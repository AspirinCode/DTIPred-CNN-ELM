...
load('./data/GPCR/bind_orfhsa_drug_gpcr.mat')  
load('./data/GPCR/GPCR_NegativeList.mat')      
load('./data/GPCR/GPCR_P_Trans.mat')      
load('./data/GPCR/GPCR_N_Trans.mat')      
...
save('./data/GPCR/CNN_Data','train_x','train_y');