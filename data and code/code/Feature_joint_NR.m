...
load('./data/NR/bind_orfhsa_drug_nr.mat')   
load('./data/NR/NR_NegativeList.mat')      

load('./data/NR/NR_P_Trans.mat')     
load('./data/NR/NR_N_Trans.mat')      
...
save('./data/NR/CNN_Data','train_x','train_y');